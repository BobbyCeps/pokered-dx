DrawPartyMenu_::
	...
	call ClearScreen
	call UpdateSprites
RedrawPartyMenu_ReloadSprites: ;added for unique party icon
...
;	farcall WriteMonPartySpriteOAMByPartyIndex  place the appropriate pokemon icon / REMOVED for unique party icon
...
.done
	...
	call Delay3
;	jp GBPalNormal
	ld a, %11100100 ; 3210 / Color party icon sprite
	ldh [rBGP], a
	ldh [rOBP0], a
	ret
.printItemUseMessage
