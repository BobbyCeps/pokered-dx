...
DEF PARTY_PAL_GREY   EQU 0
DEF PARTY_PAL_RED    EQU 1
DEF PARTY_PAL_GREEN  EQU 2
DEF PARTY_PAL_BLUE   EQU 3
DEF PARTY_PAL_YELLOW EQU 4
DEF PARTY_PAL_BROWN  EQU 5
DEF PARTY_PAL_PINK   EQU 6
DEF PARTY_PAL_PURPLE EQU 7
